...
#define SW_TIMER_INT_CTL_REG              (SW_PA_TIMERC_IO_BASE + 0x00)
#define SW_TIMER_INT_STA_REG              (SW_PA_TIMERC_IO_BASE + 0x04)
#define SW_TIMER0_CTL_REG                 (SW_PA_TIMERC_IO_BASE + 0x10)
#define SW_TIMER0_INTVAL_REG              (SW_PA_TIMERC_IO_BASE + 0x14)
#define SW_TIMER0_CNTVAL_REG              (SW_PA_TIMERC_IO_BASE + 0x18)
 ...
 *
 */
#define SW_INT_VECTOR_REG                 (SW_PA_INT_IO_BASE + 0x00)
#define SW_INT_BASE_ADR_REG               (SW_PA_INT_IO_BASE + 0x04)
#define SW_INT_PROTECTION_REG             (SW_PA_INT_IO_BASE + 0x08)
#define SW_INT_NMI_CTRL_REG               (SW_PA_INT_IO_BASE + 0x0c)
#define SW_INT_IRQ_PENDING_REG0           (SW_PA_INT_IO_BASE + 0x10)
#define SW_INT_IRQ_PENDING_REG1           (SW_PA_INT_IO_BASE + 0x14)
#define SW_INT_IRQ_PENDING_REG2           (SW_PA_INT_IO_BASE + 0x18)

#define SW_INT_FIQ_PENDING_REG0           (SW_PA_INT_IO_BASE + 0x20)
#define SW_INT_FIQ_PENDING_REG1           (SW_PA_INT_IO_BASE + 0x24)
#define SW_INT_FIQ_PENDING_REG2           (SW_PA_INT_IO_BASE + 0x28)

#define SW_INT_SELECT_REG0                (SW_PA_INT_IO_BASE + 0x30)
#define SW_INT_SELECT_REG1                (SW_PA_INT_IO_BASE + 0x34)
#define SW_INT_SELECT_REG2                (SW_PA_INT_IO_BASE + 0x38)

#define SW_INT_ENABLE_REG0                (SW_PA_INT_IO_BASE + 0x40)
#define SW_INT_ENABLE_REG1                (SW_PA_INT_IO_BASE + 0x44)
#define SW_INT_ENABLE_REG2                (SW_PA_INT_IO_BASE + 0x48)

#define SW_INT_MASK_REG0                  (SW_PA_INT_IO_BASE + 0x50)
#define SW_INT_MASK_REG1                  (SW_PA_INT_IO_BASE + 0x54)
#define SW_INT_MASK_REG2                  (SW_PA_INT_IO_BASE + 0x58)

#define SW_INT_RESP_REG0                  (SW_PA_INT_IO_BASE + 0x60)
#define SW_INT_RESP_REG1                  (SW_PA_INT_IO_BASE + 0x64)
#define SW_INT_RESP_REG2                  (SW_PA_INT_IO_BASE + 0x68)

#define SW_INT_FASTFORCE_REG0             (SW_PA_INT_IO_BASE + 0x70)
#define SW_INT_FASTFORCE_REG1             (SW_PA_INT_IO_BASE + 0x74)
#define SW_INT_FASTFORCE_REG2             (SW_PA_INT_IO_BASE + 0x78)

#define SW_INT_SRCPRIO_REG0               (SW_PA_INT_IO_BASE + 0x80)
#define SW_INT_SRCPRIO_REG1               (SW_PA_INT_IO_BASE + 0x84)
#define SW_INT_SRCPRIO_REG2               (SW_PA_INT_IO_BASE + 0x88)
#define SW_INT_SRCPRIO_REG3               (SW_PA_INT_IO_BASE + 0x8c)
#define SW_INT_SRCPRIO_REG4               (SW_PA_INT_IO_BASE + 0x90)


#define SW_UART0_THR                      (*(volatile unsigned int *)(SW_PA_UART0_IO_BASE + 0x00))
#define SW_UART0_LSR                      (*(volatile unsigned int *)(SW_PA_UART0_IO_BASE + 0x14))
#define SW_UART0_USR                      (*(volatile unsigned int *)(SW_PA_UART0_IO_BASE + 0x7c))
...
*@{
*/
#define SW_DRAM_SDR_CTL_REG               (SW_PA_DRAM_IO_BASE + 0x0C)
#define SW_DRAM_SDR_DCR                   (SW_PA_DRAM_IO_BASE + 0x04)
