...
/* Virtual Address */
// CHANGED by laurent from 0xf to 0x0 ... for temp testing
#define SW_VA_SRAM_BASE                   0x00000000	/*16KB*/

#define SW_VA_IO_BASE                     0x01c00000
#define SW_VA_SRAM_IO_BASE                0x01c00000   /* 4KB */
#define SW_VA_DRAM_IO_BASE                0x01c01000
#define SW_VA_DMAC_IO_BASE                0x01c02000
#define SW_VA_NANDFLASHC_IO_BASE          0x01c03000
#define SW_VA_TSI_IO_BASE                 0x01c04000
#define SW_VA_SPI0_IO_BASE                0x01c05000
#define SW_VA_SPI1_IO_BASE                0x01c06000
#define SW_VA_MSCC_IO_BASE                0x01c07000
#define SW_VA_TVD_IO_BASE                 0x01c08000
#define SW_VA_CSI0_IO_BASE                0x01c09000
#define SW_VA_TVE_IO_BASE                 0x01c0a000
#define SW_VA_EMAC_IO_BASE                0x01c0b000
#define SW_VA_TCON0_IO_BASE               0x01c0c000
#define SW_VA_TCON1_IO_BASE               0x01c0d000
#define SW_VA_VE_IO_BASE                  0x01c0e000
#define SW_VA_SDC0_IO_BASE                0x01c0f000
#define SW_VA_SDC1_IO_BASE                0x01c10000
#define SW_VA_SDC2_IO_BASE                0x01c11000
#define SW_VA_SDC3_IO_BASE                0x01c12000
#define SW_VA_USB0_IO_BASE                0x01c13000
#define SW_VA_USB1_IO_BASE                0x01c14000
#define SW_VA_SSE_IO_BASE                 0x01c15000
#define SW_VA_HDMI_IO_BASE                0x01c16000
#define SW_VA_SPI2_IO_BASE                0x01c17000
#define SW_VA_SATA_IO_BASE                0x01c18000
#define SW_VA_PATA_IO_BASE                0x01c19000
#define SW_VA_ACE_IO_BASE                 0x01c1a000
#define SW_VA_TVE1_IO_BASE                0x01c1b000
#define SW_VA_USB2_IO_BASE                0x01c1c000
#define SW_VA_CSI1_IO_BASE                0x01c1d000
#define SW_VA_TZASC_IO_BASE               0x01c1e000
#define SW_VA_SPI3_IO_BASE                0x01c1f000
#define SW_VA_CCM_IO_BASE                 0x01c20000
#define SW_VA_INT_IO_BASE                 0x01c20400
#define SW_VA_PORTC_IO_BASE               0x01c20800
#define SW_VA_TIMERC_IO_BASE              0x01c20c00
#define SW_VA_SPDIF_IO_BASE               0x01c21000
#define SW_VA_AC97_IO_BASE                0x01c21400
#define SW_VA_IR0_IO_BASE                 0x01c21800
#define SW_VA_IR1_IO_BASE                 0x01c21c00
#define SW_VA_IIS_IO_BASE                 0x01c22400
#define SW_VA_LRADC_IO_BASE               0x01c22800
#define SW_VA_ADDA_IO_BASE                0x01c22c00
#define SW_VA_KEYPAD_IO_BASE              0x01c23000
#define SW_VA_TZPC_IO_BASE                0x01c23400
#define SW_VA_SID_IO_BASE                 0x01c23800
#define SW_VA_SJTAG_IO_BASE               0x01c23c00
#define SW_VA_TP_IO_BASE                  0x01c25000
#define SW_VA_PMU_IO_BASE                 0x01c25400
#define SW_VA_UART0_IO_BASE               0x01c28000
#define SW_VA_UART1_IO_BASE               0x01c28400
#define SW_VA_UART2_IO_BASE               0x01c28800
#define SW_VA_UART3_IO_BASE               0x01c28c00
#define SW_VA_UART4_IO_BASE               0x01c29000
#define SW_VA_UART5_IO_BASE               0x01c29400
#define SW_VA_UART6_IO_BASE               0x01c29800
#define SW_VA_UART7_IO_BASE               0x01c29c00
#define SW_VA_PS20_IO_BASE                0x01c2a000
#define SW_VA_PS21_IO_BASE                0x01c2a400
#define SW_VA_TWI0_IO_BASE                0x01c2ac00
#define SW_VA_TWI1_IO_BASE                0x01c2b000
#define SW_VA_TWI2_IO_BASE                0x01c2b400
#define SW_VA_CAN0_IO_BASE                0x01c2bc00
#define SW_VA_CAN1_IO_BASE                0x01c2c000
#define SW_VA_SCR_IO_BASE                 0x01c2c400
#define SW_VA_GPS_IO_BASE                 0x01c30000
#define SW_VA_MALI_IO_BASE                0x01c40000
#define SW_VA_DEFE0_IO_BASE               0x01e00000
#define SW_VA_DEFE1_IO_BASE               0x01e20000
#define SW_VA_DEBE0_IO_BASE               0x01e60000
#define SW_VA_DEBE1_IO_BASE               0x01e40000
#define SW_VA_MP_IO_BASE                  0x01e80000
#define SW_VA_AVG_IO_BASE                 0x01ea0000
