...
#define UART1_RBR (SUNXI_UART1_BASE + 0x0)    /* receive buffer register */
#define UART1_THR (SUNXI_UART1_BASE + 0x0)    /* transmit holding register */
#define UART1_DLL (SUNXI_UART1_BASE + 0x0)    /* divisor latch low register */

#define UART1_DLH (SUNXI_UART1_BASE + 0x4)    /* divisor latch high register */
#define UART1_IER (SUNXI_UART1_BASE + 0x4)    /* interrupt enable reigster */

#define UART1_IIR (SUNXI_UART1_BASE + 0x8)    /* interrupt identity register */
#define UART1_FCR (SUNXI_UART1_BASE + 0x8)    /* fifo control register */

#define UART1_LCR (SUNXI_UART1_BASE + 0xc)    /* line control register */

#define UART1_LSR (SUNXI_UART1_BASE + 0x14)   /* line status register */
